...
Cube = function (colors, x, y, z) {
  this.colors = colors;
  if (colors && colors.slice) {
    this.original_colors = colors.slice();
  }
...
Cube.prototype.rotate_x = function () {
  ...
  if (this.original_colors) cycle(this.original_colors, [1, 5, 4, 2]);
}

Cube.prototype.rotate_y = function () {
  cycle(this.colors, [0, 2, 3, 5]);
  if (this.original_colors) cycle(this.original_colors, [0, 2, 3, 5]);
}

Cube.prototype.rotate_z = function () {
  cycle(this.colors, [0, 4, 3, 1]);
  if (this.original_colors) cycle(this.original_colors, [0, 4, 3, 1]);
}
